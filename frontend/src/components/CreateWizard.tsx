        ...
        <section className="space-y-6">
                ...
                <button
                  ...
                  className={`rounded-full px-4 py-2 text-sm ${
                    durationMin === d
                      ...
                      : "border border-black/10 bg-white/70 text-[var(--foreground)]"
                  }`}
                >
                  {d} min
                </button>
                    ...
                    className={`rounded-full px-4 py-2 text-sm ${
                      mode === m && enabled
                        ...
                        : enabled
                          ...
                          : "cursor-not-allowed border border-black/5 bg-black/[0.03] text-[var(--ink-muted)] opacity-70"
                    }`}
          ...
          <div className="flex justify-between gap-3">
            <button
              ...
              className="rounded-full border border-black/10 bg-white/70 px-5 py-2.5 text-sm"
            >
              Back
            </button>
            <button
